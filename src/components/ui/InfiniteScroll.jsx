...
export default function InfiniteScroll({
  ...
  const getTiltTransform = () => {
    ...
    return tiltDirection === "left"
      ? "rotateX(20deg) rotateZ(-30deg) skewX(30deg)"
  ...
  return (
    <div
      className="relative h-full lg:h-[68%] flex items-center justify-center w-full overflow-hidden overscroll-none border-t-2 border-b-2 border-t-dotted border-b-dotted border-transparent"
      ref={wrapperRef}
      // style={{ maxHeight }}
    >
      {/* Gradient Overlays */}
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center bg-gradient-to-r from-sky-950 via-gray-950 to-gray-700/50 justify-center p-4 text-xl font-semibold text-center border-2 border-white/10 rounded-[15px] select-none box-border relative"
            key={i}
            style={{
